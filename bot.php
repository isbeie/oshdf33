...
////////////////=============[GUNNU CHK BOT]=============////////////////
$botToken = "BOT TOKEN"; // 5340638171:AAHGlF78oNj9DesADBODkztjdFBbhKOG1nk
...
sendMessage($chatId, "<b><i>[Checker Gates]%0A%0ASTRIPE CUSTOM CHARGE -%0A/chk{Amount In $} - xxxxxxxxxxxxxxxx|xx|xx|xxx%0A/inr{Amount In ₹} - xxxxxxxxxxxxxxxx|xx|xx|xxx%0ABIN LOOKUP - /bin -  xxxxxx%0ASK CHECK - /sk -  sk_live_xxxxxxxxxxGuNNu%0A%0A[Tools]%0A%0ATELEGRAM ID/GROUP ID - /id</i></b>", $message_id);
}
